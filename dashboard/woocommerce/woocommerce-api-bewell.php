      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
			...
			<?php
				...
				$url= "https://www.bewellstyle.com/wc-api/v3/orders?consumer_key=ck_fbf9e971dd2b18fb15c79b931110914abd5fd5c6&consumer_secret=cs_a8a3e31cc956ba9d0a17346751d26cabc6305d75&status=processing&filter[limit]=15";
				...
				while($x <=  $order_id = $json['orders'][$x]['id'].length) {
					...
					$setTotal_quantity 		= iconv("UTF-8","TIS-620",$json['orders'][$x]['total_line_items_quantity']);
					...
					//echo "Insert new order Completed"."\n";
						$strSQL = "INSERT INTO WOOCOMMERCE_BEWELL(ORDER_NUMBER,CUSTOMER_NAME,ADDRESS,POSTCODE,PHONE_NUMBER,EMAIL,SHIPPING,PAYMENT_ID,PAYMENT_TITLE,SUBTOTAL,TOTAL_SHIPPING,TOTAL_DISCOUNT,TOTAL_PRICE,TOTAL_QUANTITY,SHOP_CHANNEL,STATUS_WOO)
						VALUES('$order_id','$setName','$setAddress','$setPostcode','$setPhoneNumber','$setEmail','$setShipping','$setPayment_id','$setPayment_title','$setSubtotal','$setTotal_shipping','$setTotal_discount','$setTotal_price','$setTotal_quantity','Woocommerce','Processing')";
...
while($row2 = odbc_fetch_array($result)){
						...
						?>
						  <tr>
							<td align="left"><a href='http://www.dplus-system.com:8080/dplus-commerce/ecommerce/dashboard/woocommerce/woocommerce-api-bewell-detail.php/?on=<?php echo $row2["ORDER_NUMBER"]; ?>'><?php echo $row2["ORDER_NUMBER"];?></a></td>
